...
// d. Заповнити масив 20ма рандомними чисалами в діапазоні від additional-8 до 732 (Google: Generate random number JS)
let all = [];
 for (let i = 0; i < 20; i++) {
...
// EXAMPLE: [ 1, 2, 3, 5, 7, 9, 56, additional-8, 67 ] -> Має бути виведено 1, 9, 56
// let numbers = [1, 2, 3, 5, 7, 9, 56, additional-8, 67];
...
// additional-8. Створити масив з будь якими значеннями (стрінги, числа, і тд...). пройтись по ньому, і якщо елемент є числом -
